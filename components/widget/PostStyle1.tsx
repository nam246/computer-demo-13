...
import { MotionFadeRight } from "../Animate/MotionFadeRight";
import { MotionFadeUp } from "../Animate/MotionFadeUp";
...
export default async function PostStyle1() {
	return (
		<div>
